...
UROS_COM_APP_ConnHandleNotEvt_t UROS_COMHandleNotification;
...
{
  14, AD_TYPE_COMPLETE_LOCAL_NAME, 'X', 'X', '-', 'U', 'R', 'O', 'S', '-', 'S', 'T', 'M', '3', '2',  /* Complete name */
};
...
SVCCTL_UserEvtFlowStatus_t SVCCTL_App_Notification(void *p_Pckt)
{
  ...
  switch (p_event_pckt->evt)
  {
    case HCI_DISCONNECTION_COMPLETE_EVT_CODE:
    {
      ...
      UROS_COMHandleNotification.EvtOpcode = UROS_COM_DISCON_HANDLE_EVT;
      UROS_COMHandleNotification.ConnectionHandle = p_disconnection_complete_event->Connection_Handle;
      UROS_COM_APP_EvtRx(&UROS_COMHandleNotification);
    ...
    case HCI_LE_META_EVT_CODE:
    {
      ...
      switch (p_meta_evt->subevent)
      {
        ...
        case HCI_LE_ENHANCED_CONNECTION_COMPLETE_SUBEVT_CODE:
        {
          ...
          UROS_COMHandleNotification.EvtOpcode = UROS_COM_CONN_HANDLE_EVT;
          UROS_COMHandleNotification.ConnectionHandle = p_enhanced_conn_complete->Connection_Handle;
          UROS_COM_APP_EvtRx(&UROS_COMHandleNotification);
        ...
        case HCI_LE_CONNECTION_COMPLETE_SUBEVT_CODE:
        {
          ...
          UROS_COMHandleNotification.EvtOpcode = UROS_COM_CONN_HANDLE_EVT;
          UROS_COMHandleNotification.ConnectionHandle = p_conn_complete->Connection_Handle;
          UROS_COM_APP_EvtRx(&UROS_COMHandleNotification);
